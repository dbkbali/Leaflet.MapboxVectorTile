...
module.exports = L.TileLayer.MVTSource = L.TileLayer.Canvas.extend({
	...
	_draw: function (ctx) {
        ...
        if (self.map.getZoom() == null) return;
				...
				if (self.map && self.map.getZoom() != null) {
